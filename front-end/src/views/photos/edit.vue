            ...
            <div class="card-body">
                ...
                <div class="form">
                    ...
                    <div class="input-group mb-5">
                        ...
                        <textarea id="upload_description" v-model="description" class="form-control"
...
<script>
    ...
    import {getPhotoById, edit} from "@/api/photo";
    ...
    export default {
        ...
        methods: {
            ...
            submitUpload() {
                ...
                formData.append("photoId", this.photo.photoId);
        ...
        mounted: function () {
            ...
            getPhotoById({photoId: id}).then(response => {
                ...
                this.selectedTheme = this.photo.theme;
                getCountries().then(response => {
                    const {data} = response;
                    this.country_ops = data;
                    for (let country of this.country_ops) {
                        // console.log(country.CountryName);
                        if (country.CountryName === this.photo.countryCode) {
                    ...
                    getCitiesByISO({CountryCode: this.selectedCountry}).then(response => {
                        const {data} = response;
                        this.city_ops = data;
                        for (let city of this.city_ops) {
                            if (city.cityName === this.photo.cityCode) {
